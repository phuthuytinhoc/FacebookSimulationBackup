<?php
	...
	$query = 'insert into status(statusID, content) values(\'STT'.$time.'\', \''.$status.'\')';
	@mysql_query($query, $conn);
	
	$query = 'insert into action(actionID, actionUser, actionLocation, actionType, timeUpdate, actionLocate, actionLatitude, actionLongitude) values(\'ACT'.$time.'\', \''.$_SESSION['email'].'\', \''.$_SESSION['user'].'\', \'STT'.$time.'\','.$time.', \''.$locate.'\', '.$lat.', '.$long.')';
	@mysql_query($query, $conn);
